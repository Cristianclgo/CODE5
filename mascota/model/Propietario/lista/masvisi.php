...
<tr><br>
    ...
    <input type="submit" formaction="../indexP.php" value="Regresar"class="btn btn-outline-primary" />
    </tr>
</form>
        ...
        <table class="table table-striped" >
            ...
            <tr>
                <?php
                    ...
                    and visita.id_estado = estado.id_estado and usuario.iduser = '".$_SESSION['id_user']."' and mascotasclientes.iduser ='".$_SESSION['id_user']."'";
                    $i=0;
                ...
                <tr>
                    ...
                    <a href="?id=<?php echo $result['idVisita'] ?>" onclick="window.open('med1.php?id=<?php echo $result['idVisita'] ?>','','width= 600,height=500, toolbar=NO');void(null);"class="btn btn-Primary btn-sm">
                    <i class="fas fa-pills btn-outline-light"></i>MEDICAMENTOS</a>   
                    </button></td> 
                </tr>
                    <?php 
                    }
