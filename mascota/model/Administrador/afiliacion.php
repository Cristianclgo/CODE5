...
<head>
    ...
    <body>
        ...
        <section class="title">
            <h1 class="text-uppercase fw-bold"> AFILIACIÓN</h1>
        </section>
     ...
     <!--tabla donde se digitan las variables-->
                ...
                <div class="mb-3">
                    <tr>
                        ...
                        <th><input type="number" name="Afilb" placeholder="Ingrese numero de afiliaciòn" class="form-control"  require ></th>
                    </tr>   
                </div>
                <div class="mb-3">
                    <tr>
                        <th><label>FECHA AFILIACIÒN</label></th>
                        <th><input type="date" name="dateafilb" placeholder="SELECCIONAR FECHA" class="form-select"></th>
                    </tr>
                </div>
                <div class="mb-3">
                    <tr>
